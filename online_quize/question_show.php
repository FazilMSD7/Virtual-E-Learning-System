 <!-- navigation bar starts -->
  ...
  <a class="navbar-brand text-white" href="../index.php">FazilMSD7</a>
...
<center><div class="row col-sm-7 ">
  <script type="text/javascript">
      var timeleft=2*60;                                   //important--> the scope of javascript variable is global but not in php(we have to use global keyword)
